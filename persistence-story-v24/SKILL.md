---
name: persistence-story-v24
description: >-
  Generate a completely technical, LLD-level Persistence Story.
---
...
```yaml
skill:
  id: persistence-story
  name: Persistence Story
  version: 2.0.0
  purpose: Generate a completely technical, LLD-level Persistence Story.
  story_area: Persistence
  responsibility:
    owns:
    - technical implementation design for the Persistence slice
  ...
  inputs:
    ...
    - target_contracts
  source_usage:
    primary: architecture_blueprint data ownership + persistence decisions + migration_strategy + AAC
  ...
  constraints:
    must:
    - set area exactly to "Persistence"
