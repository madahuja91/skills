...
skill:
  ...
  exact_subagent_names:
    note: subagenttool subagent_name must match workflow node labels exactly. Never invent snake_case aliases.
    orchestrators:
