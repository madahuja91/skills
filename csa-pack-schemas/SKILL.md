...
| `arc42-c4/{index,context,containers,components}.html` | `arc42-c4-views` + `mermaid-diagrams` |
...
4. Required Mermaid IDs per `mermaid-diagrams` (blocking).
