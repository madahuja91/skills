...
5. **Client pack = legacy only:** no workflow/swarm/gate/process meta in any `csa_pack/**` file.
...
required_files_present, artifact_schema_conformance, specialist_list_depth, forbidden_duplicate_trees, section_anti_redundancy, pack_shape_valid, shared_memory_present, no_workflow_meta_in_csa_pack
