...
2. Completeness builds **pack substance** that validates against each `output-schemas/*.schema.json`, then renders five Markdown owners (`csa5-section-boundaries`).
