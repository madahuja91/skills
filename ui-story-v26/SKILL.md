...
name: ui-story-v26
description: >-
  Generate a completely technical, LLD-level UI Story.
---
...
skill:
  ...
  name: UI Story
  version: 2.0.0
  purpose: Generate a completely technical, LLD-level UI Story.
  story_area: UI
  responsibility:
    owns:
    - technical implementation design for the UI slice
  ...
  inputs:
    ...
    - target_contracts
  source_usage:
    primary: Feature/FAC + target UI/API contracts in architecture_blueprint + current-state user interaction evidence
