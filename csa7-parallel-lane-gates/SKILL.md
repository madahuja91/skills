...
Bootstrap src/ + shared memory
  -> Discover -> Completeness(csa7-gate-discover)
...
3. Validate pack against `csa7-gate-document` + pack output-schemas
...
|------|---------|----------|
| Discover | csa7-gate-discover | artifacts/discovery.json |
| Domain | csa7-gate-business-domain | artifacts/domain.json |
| Tech | csa7-gate-tech-architecture | artifacts/architecture.json |
| Lineage | csa7-gate-data-lineage | artifacts/lineage.json |
| Integration | csa7-gate-integration | artifacts/integration.json |
