...
Final report must also conform to `skills/shared/csa7-quality-gate-framework/schema.json`.

## Target

- Artifact: `artifacts/discovery.json`
- Artifact schema: `skills/agents/csa7-discover/schema.json`
- Rubric: `skills/agents/csa7-discover/quality-rubric.md`
