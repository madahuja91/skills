...
skill:
  ...
  epic_names:
    ...
    when_provided: Use user Epic names verbatim as epic title; do not rename or rephrase; one Epic per name; id, folder, and file are epic-<verbatim title> (e.g. epic-System Data Management). Never EPIC-001.
  source_usage:
    codebase:
  ...
  output:
    ...
    - traceability
  naming:
    pattern: epic-<Business Capability>
    examples:
