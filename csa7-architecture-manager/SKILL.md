...
- Soft checks (line count / Mermaid fence only) are **not** done criteria — Completeness must prove pack_substance vs `csa7-pack-schemas`.

## HARD — load skills (do not restate)

- `csa7-swarm-shared-memory`
- `csa7-parallel-lane-gates`
- `csa7-active-root-hygiene`
- `csa7-section-boundaries` / `csa7-rich-content`
...
Bootstrap src/ + shared memory
  ...
  -> Completeness(FINAL): render src/csa_pack + csa7-gate-document
...
3) Validate with csa7-gate-document + pack output-schemas
...
## HARD — knowledge-first outcome

Do not accept specialist done signals if pack_substance lacks narrative fields (what/why/how, AC, DDD, persistence strategy, decision_log, modernization, evidence_appendix).
Never write csa_pack yourself — Completeness FINAL renders knowledge-first MD.
