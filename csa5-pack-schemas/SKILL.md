...
| `arc42-c4/{index,context,containers,components}.html` | `csa5-arc42-c4-views` + `csa5-mermaid-diagrams` |
...
4. Required Mermaid IDs per `csa5-mermaid-diagrams` (blocking).
