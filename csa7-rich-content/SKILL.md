...
2. Completeness builds **pack substance** that validates against each `output-schemas/*.schema.json`, then renders five Markdown owners (`csa7-section-boundaries`).
...
## HARD — knowledge-first render

Client Markdown must explain the system (What/Why/How, rules, AC, DDD, persistence, decisions, modernization).
Evidence Mapping appendix is **last**. Evidence-led Component→File tables as the main body = FAIL.
