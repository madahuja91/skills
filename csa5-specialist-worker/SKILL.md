...
Policy details live in attached skills (`csa5-specialist-worker` and domain skills).

## HARD — obey these skills (do not restate them in prompts)

| Concern | Skill |
|---------|-------|
| Single ACTIVE_ROOT / disk paths | `csa5-active-root-hygiene` |
| Shared memory read/write / handoffs | `csa5-swarm-shared-memory` |
| Artifact envelope + IDs + evidence | `csa5-artifact-contract` |
| Evidence citation shape | `csa5-evidence-citation` |
