...
Bootstrap src/ + shared memory
  -> Discover -> Completeness(csa6-gate-discover)
...
3. Validate pack against `csa6-gate-document` + pack output-schemas
...
|------|---------|----------|
| Discover | csa6-gate-discover | artifacts/discovery.json |
| Domain | csa6-gate-business-domain | artifacts/domain.json |
| Tech | csa6-gate-tech-architecture | artifacts/architecture.json |
| Lineage | csa6-gate-data-lineage | artifacts/lineage.json |
| Integration | csa6-gate-integration | artifacts/integration.json |
