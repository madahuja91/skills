...
| All required Mermaid diagram IDs present (MD + arc42 HTML) | required |
| arc42 index.html full hub (≥12 anchors, ≥2 Mermaid, classic runtime) | required |
| On fail: target_agent_id set for Manager re-run | required |
