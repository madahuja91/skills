...
```yaml
when_empty: LLM derives Epic titles from evidence using business capability/outcome
  naming.
when_provided: Use user Epic names verbatim as epic title; do not rename or rephrase;
  one Epic per name; still assign EPIC-### IDs.
```
